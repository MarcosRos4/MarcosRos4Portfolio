      ...
      <div className="conatiner max-w-4xl mx-auto text-center z-10">
        <div className="space-y-6">
            ...
            <h1 className="text-4xl md:text-6xl font-bold tracking-tight">
                <span className="opacity-0 animate-fade-in">Olá, meu nome é</span>
                <span className="text-primary opacity-0 animate-fade-in-delay-1"> Marcos </span>
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-2xl mx-auto opacity-0 animate-fade-in-delay-3 ">
                Desenvolvo código Full Stack, voltado a Web-Dev (React, API Rest, SQL, etc...)
            </p>
